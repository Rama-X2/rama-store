...
const portfolioData = {
  ...
  projects: [
    ...
    },
    {
      ...
      description: "A full-featured server management dashboard for business operations, combining analytics, network control, and user insights. Designed with performance-first principles and optimized for fast load times and data visualizations.",
    ...
    },
    {
      ...
      description: "ROM custom ringan berbasis Android 15 (Vanilla Ice Cream) yang disempurnakan dengan asisten AI cerdas yang dibangun menggunakan TensorFlow dan NLP. Proyek ini mengintegrasikan antarmuka pengguna responsif dengan kemampuan pemahaman bahasa alami, menjadikannya basis ideal untuk pengalaman seluler yang disempurnakan dengan AI. 『 Builder: Rama-X2 』",
      image: "/images/portfolio/banner_rom-pixel.png",
      technologies: ["Android Open Source Project (AOSP)", "Android 15 Vanilla Ice Cream", "Shell Scripting", "Python", "TensorFlow", "On-device NLP", "Flask", "Java & Kotlin"],
    ...
    {
      id: 5,
      title: "RISING UI 2.5 – Evolution X Customization for POCO F5",
      description: "RISING UI 2.5 adalah modul kustomisasi UI eksklusif untuk ROM Evolution X pada POCO F5. Project ini menawarkan peningkatan pengalaman visual dan kontrol sistem tanpa mengorbankan stabilitas ROM utama. Dibuat untuk pengguna yang ingin personalisasi mendalam dari tampilan lockscreen, status bar, hingga animasi sistem semuanya disatukan dalam antarmuka elegan dan responsif. Di distribusikan sebagai UI pack ringan yang kompatibel dengan sistem Evolution X berbasis Android 13–14, project ini dikembangkan dan dirawat oleh Rama-X2, dan merupakan bagian dari seri eksperimental bertema visual anime dan minimalistik.",
      image: "/images/portfolio/kernel_poco-f5.png",
      technologies: ["Android AOSP", "Evolution X", "Magisk Module", "Kotlin / Java", "Overlay Manager Service (OMS)"],
